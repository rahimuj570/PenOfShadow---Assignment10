    ...
    <div id="contact" className="my-10">
      ...
      <div className="mb-5 w-4/6 md:w-3/6 mx-auto">
        ...
        <p className="text-base mt-1 font-exo text-center">
          I Have Enough Free Time for My Clients.
        </p>
      </div>
          ...
          <div className="mt-2 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              >
                ...
                <button
                  type="submit"
                  className="font-exo text-base md:w-32 bg-red-500 hover:bg-blue-dark text-white font-bold py-2 px-3 rounded-lg mt-3 hover:bg-white hover:shadow hover:text-red-500 transition ease-in-out duration-300"
                >
                  Submit
                </button>
              </form>
