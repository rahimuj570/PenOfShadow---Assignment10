          ...
          <div class="mt-2 overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-2">
              ...
              >
                ...
                <button
                  type="submit"
                  class="font-exo text-base md:w-32 bg-red-500 hover:bg-blue-dark text-white font-bold py-2 px-3 rounded-lg mt-3 hover:bg-white hover:shadow hover:text-red-500 transition ease-in-out duration-300"
                >
                  Submit
                </button>
              </form>
